...
pan-Ashaninka possesses partial and total reduplication of its verbal roots on their own or accompanied by epenthetic prefixes/suffixes as well as subject prefixes `(5)` and a irrealis infix `(5)`.
