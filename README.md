...
Our analysis of the collected text corpus, shows that Ashaninka uses both partial reduplication 'bounded copy' `(1)` and total reduplication 'unbounded copy' `(2)` as productive morphological operations (two-way finite state transducers will be employed in order to create an adequate model).
