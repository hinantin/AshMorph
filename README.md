...
This is a morphological analyzer for pan-Ashaninka (list varieties under the umbrella) written using Xerox finite state technology with a quadrilingual lexicon (Ashaninka, English, Spanish and Portuguese).
