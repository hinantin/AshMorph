...
This is a morphological analyzer for pan-Ashaninka (varieties under the umbrella ...) written using Xerox finite state technology with a quadrilingual lexicon (Ashaninka, English, Spanish and Portuguese).
