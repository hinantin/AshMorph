...
compile:
	@rm -f n-vroot.prq.foma | perl extractEntries.pl --file nroot.prq.foma --file nroot.es.foma --file aroot.prq.foma --file ideo.prq.foma --file numeral.prq.foma --outputfilename "n-vroot.prq.foma" --flag "N@->V" --title "Verbalized entries" --header "NounToVerbPRQin" --replace 2 --source "\" : {" --target "+vbz.\" : {"
