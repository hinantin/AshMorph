...
compile:
	...
	@rm -f verb.classifier.prq.foma | perl extractEntries.pl --file noun.suffix.prq.script --outputfilename "verb.classifier.prq.foma" --flag "@CL" --title "VERBAL CLASSIFIERS (VERB.CL)" --header "V=S=CL" --replace 2 --source "\+CL:" --target "+VERB.CL:"
