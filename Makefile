...
compile:
	...
	@rm -f verb.classifier.prq.foma | perl extractEntries.pl --file n-s-cl.foma --outputfilename "verb.classifier.prq.foma" --label "@CL" --title "VERBAL CLASSIFIERS (VERB.CL)" --header "V=S=CL" --replace1 1 --replace2 1 --source2 "\+CL:" --target2 "+VERB.CL:"
