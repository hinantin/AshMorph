...
cp $TMP_DIR/$filename_no_ext.test.xfst /home/richard/Downloads/$filename_no_ext.test.xfst
# (2) CRF before|after
...
cp $TMP_DIR/$filename_no_ext.disamb.xfst /home/richard/Downloads/$filename_no_ext.disamb.xfst
